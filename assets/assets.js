...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'HTML, CSS, JavaScript, Node.Js, Express.Js, MySQL, MangoBD, React.Js, Next.Js' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: ' Full-Stack Web Development course, Bachelor of accountancy' },
